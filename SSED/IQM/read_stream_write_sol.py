...
from extract_lattice_info import extract_lattice_info
...
def read_stream_write_sol(stream_file_path):
    lattice = extract_lattice_info(stream_file_path)
...
if __name__ == "__main__":
    ...
    stream_file_path = '/home/buster/UOX1/different_index_params/5x5_retry/best_results_IQM.stream'  # Update this with your actual file path
    # Process the stream file and write output to the .sol file
    lines_written = read_stream_write_sol(stream_file_path)
