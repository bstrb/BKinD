...
class AnnularBeamIntensityApp:
    ...
    def calculate_intensities(self):
        ...
        # Print the fitted annulus details only once
        # print(f"Fitted Annulus: Center = {self.center}, Inner Radius = {self.inner_radius:.2f}, Outer Radius = {self.outer_radius:.2f}")
