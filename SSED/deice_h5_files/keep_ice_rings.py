...
def keep_ice_rings(input_file, output_file, min_spots=10, inner_radius=100, outer_radius=150):
...
if __name__ == "__main__":
    ...
    output_file = "/home/buster/UOX123/icerings_UOX1_minpeaks_15.h5"  # Example output file path
    ...
    keep_ice_rings(input_file, output_file, min_spots, inner_radius, outer_radius)
