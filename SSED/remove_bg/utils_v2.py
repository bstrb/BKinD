...
def process_image(image, mask, center_x, center_y, max_peaks=5):
    ...
    peak_count = min(len(peaks), max_peaks)  # Limit the number of peaks to max_peaks
    print(f"Automatically determined number of peaks (limited by max_peaks={max_peaks}): {peak_count}")
