...
def setup_main_frame(self, xray=False):
    ...
    if os_name == 'Darwin':
        if xray:
            ...
            self.xds_dir = tk.StringVar(value="/Users/xiaodong/Desktop/3DED-DATA/LTA/LTA1/xds")
            self.shelx_dir = tk.StringVar(value='/Users/xiaodong/Desktop/3DED-DATA/LTA/LTA1/shelx')
