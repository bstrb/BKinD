...
# def prepare(shelx_directory, output_dir, crystal_name, target_completeness, xds_directory=None, xray=False, progress=None):
#     """
...
#     - progress (ttk.Progressbar, optional): Progress bar to update during preparation.
#     """
#     output_folder = create_subfolder(output_dir, crystal_name, target_completeness, xray)
    
#     remove_macos_artifacts(shelx_directory)
    
#     steps = 3  # Number of steps in the prepare stage
