...
def save_statistics(stats_filename, original_count, initial_completeness, target_completeness, resulting_completeness, iteration, data_filtered_percentage, data_filtered_count, remaining_unique_asus, filtered_completeness):
    """
    ...
    try:
        ...
        with open(stats_filename, 'a') as file:
            ...
            file.write(f"Resulting Completeness of Removed Data: {filtered_completeness:.1f} %\n")
            file.write(f"Resulting Completeness of Remaining Data: {resulting_completeness:.1f} %\n")
