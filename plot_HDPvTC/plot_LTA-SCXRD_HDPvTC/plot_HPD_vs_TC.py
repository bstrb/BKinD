...
# Example usage
file_paths = ['LTA.txt','LTA_atom_removed.txt']  # Add more file names if you have multiple datasets
labels = ['LTA','LTA atom removed']  # Corresponding labels for each file
