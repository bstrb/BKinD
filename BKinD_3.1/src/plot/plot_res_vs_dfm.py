...
def plot_Resolution_vs_DFM(output_folder):
    """
    Creates an interactive plot of 'DFM' vs 'Resolution' from all CSV files in the specified folder,
    ...
    for file in files:
        ...
        try:
            ...
            if 'DFM' not in df.columns or 'Resolution' not in df.columns:
                print(f"Warning: 'DFM' or 'Resolution' not found in {file}. Skipping this file.")
                continue
    ...
    plotname="Resolution_vs_DFM.html"
