...
from damped_sinusoids_v2 import process_image
...
def process_and_write_image(image_index, images_dataset, center_x_dataset, center_y_dataset, corrected_images_dataset):
...
def remove_background(h5_file_path, new_h5_file_path):
    ...
    with h5py.File(h5_file_path, 'r') as h5_file:
        ...
        with h5py.File(new_h5_file_path, 'w') as new_h5_file:
            ...
            # Create the 'images' dataset in the new file with CHUNKED storage layout
...
if __name__ == "__main__":
    ...
    new_h5_file_path = '/home/buster/UOX1/deiced_UOX1_min_15_peak_corrected_ds_v2.h5'
