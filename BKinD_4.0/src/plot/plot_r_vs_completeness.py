...
def plot_R1_Rint_vs_completeness(output_folder):
    ...
    # Set x-axis title
    fig.update_xaxes(title_text='Target Removed Data Completeness (%)')#, autorange="reversed")

    # Set y-axes titles and apply font sizes
    fig.update_layout(
        title=dict(text='R1, Rint, Remaining Data % and Average Multiplicity vs Removed Data Completeness', font=dict(size=32)),
