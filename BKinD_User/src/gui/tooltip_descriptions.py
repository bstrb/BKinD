...
When enabled, the program will use SHELXT to solve the structure for the data(removed or remaining) after filtering.
The resulting files are found in their respective subfolder with _a.res as ending."""
