...
def process_stream_file(stream_file_path, wrmsd_weight, cd_weight, rpr_weight):
    try:
...
def evaluate_multiple_streams(stream_file_folder, wrmsd_weight, cd_weight, rpr_weight):
    try:
        ...
        with ProcessPoolExecutor() as executor:
            futures = {executor.submit(process_stream_file, path, wrmsd_weight, cd_weight, rpr_weight): path for path in stream_file_paths}
