...
from utils_v2 import process_image
# from process_image_v3 import process_image
# from plot_results_v2 import plot_results
...
def process_frame(h5_file_path, mask_file_path):
    ...
    with h5py.File(h5_file_path, 'r') as h5_file:
        ...
        while True:
            try:
                ...
                if image_index < 0 or image_index >= num_images:
                    print("Invalid image index. Please enter a value within the range.")
                else:
                    break
            except ValueError:
        ...
        # corrected_image, corrected_image_no_mask, radial_distances, radial_medians, popt = processed_data
