...
#     run = 1
#     stream_files = glob.glob(f'{stream_dir}/*.stream')  # Find all .stream files in the input directory
...
#                 print(f"[{index + 1}/{total_files}] Running merging for ring sizes: {ring_sizes}")
...
#                 print(f"Completed merging for ring sizes: {ring_sizes}")
#         except subprocess.CalledProcessError as e:
#             print(f"Error during merging for {stream_file}: {e}")
#             continue
